...
Hidden elsewhere in the output we can see the parse reconstructing the program from it's current understanding (notice the current lack of function bodies):
